...
\section{src.utils.image}%Modules for sprites of level objects
...
\section{src.utils.physics}%Physics for calculating collisions of level objects
...
\section{src.gui.text}%Graphical user interface
\section{src.gui.menu}
\section{src.gui.statusbar}


\section{src.core.highscores}%Further game features
\section{src.utils.sound}
